...
<head>
  ...
  <body>
    ...
    <div class="col-md-12">
        <form name="dados" method="post" action="router.php?op=6">
      ...
      <div class="form-group">
        ...
        <input type="text" name="periodo"> Formato(Ex: 15.1)
    </div>

    <input class="btn-primary" type="submit" value="Cadastrar"><br><br>
