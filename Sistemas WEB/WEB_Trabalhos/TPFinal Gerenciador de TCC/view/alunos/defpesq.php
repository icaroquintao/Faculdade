...
<head>
  ...
  <body>
    ...
    <div class="col-md-12">
        <form name="dados" method="post" action="router.php?op=18">
        ...
        <div class="form-group">
          <label for="pesq">Escreva o resumo da sua pesquisa:</label>
          <input type="text" name="pesq" class="single-textarea">
      </div>
